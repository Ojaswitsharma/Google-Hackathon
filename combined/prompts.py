...
Create a calming, immersive story based on:
WORLD TYPE: {world_type}
EMOTION: {emotion} 
NARRATIVE THEME: {narrative}

The story should be {min_words}-{max_words} words and:
...
- End with a sense of peace and empowerment
- Avoid any negative or triggering content

Create a story that makes the reader feel transported to this safe world."""
